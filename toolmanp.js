...
pencil.addEventListener("click", function (e) {
    if (cTool == "pencil") {
        ...
        tool.lineWidth = pencilSize;//for 2 way binding
...
eraser.addEventListener("click", function (e) {
    ...
    // first click
        ...
        tool.lineWidth = eraserSize;//for 2 way binding
...
rect.addEventListener("click", function (e) {
    if (cTool == "rect") {
        ...
        cTool = "rect";
        tool.strokeStyle = "lightpink";
        tool.lineWidth = rectSize;//for 2 way binding
...
line.addEventListener("click", function (e) {
    if (cTool == "line") {
        ...
        cTool = "line";
        tool.strokeStyle = "lightpink";
        tool.lineWidth = lineSize;//for 2 way binding
    }
})
